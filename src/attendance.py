...
GPIO.setup(Buzzer, GPIO.OUT,initial=GPIO.LOW) # DB7
...
image = CurrentFolder+'/Ritesh.png'
image2 = CurrentFolder+'/Jyoti.png'
image3 = CurrentFolder+'/Himadri.png'
image4 = CurrentFolder+'/Nikhilesh.png'
...
known_face_encodings = [
    ...
    person3_face_encoding,person4_face_encoding
]
known_face_names = [
    person1_name,person2_name,person3_name,person4_name
]
